	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				options: [
					{ name: 'Custom Script', value: 0, description: 'Shell command run on the Zabbix agent or server' },
					{ name: 'IPMI', value: 1, description: 'IPMI command' },
					{ name: 'SSH', value: 2, description: 'Command run over SSH' },
					{ name: 'Telnet', value: 3, description: 'Command run over Telnet' },
					{ name: 'Webhook', value: 5, description: 'JavaScript executed by the Zabbix server' },
				],
			},
		],
	},
